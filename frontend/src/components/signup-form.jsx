            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-muted-foreground text-balance">
                  SignUp to your Streamify Account
                </p>
              </div>
              <Field>
                <FieldLabel htmlFor="name">Name</FieldLabel>
                <Input id="name" type="name" placeholder="John Doe" required onChange={(e) => setFormData({ ...formData, fullName: e.target.value })} />
              </Field>
              <Field>
              ...
              <Field>
                ...
                <Input id="phone" type="number" placeholder="xxxxxxxxxx" required onChange={(e) => setFormData({ ...formData, phone: e.target.value })} />
              </Field>
              <Field>
              ...
              <Field className="flex justify-center items-center w-sm m-auto gap-4">
